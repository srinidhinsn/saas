    ...
    <div style={{ display: 'flex' }}>
      ...
      <div style={{ flex: 1 }}>
        <Routes>
          ...
          <Route
            path="/main"
            element={clientId ? <MainPage /> : <Navigate to="/login" />}
          />
          <Route
            path="/update-profile"
            element={clientId ? <UpdateProfile /> : <Navigate to="/login" />}
          />
          <Route
            path="/settings"
            element={clientId ? <Settings /> : <Navigate to="/login" />}
          />

          {/* Menu Pages */}
          <Route
            path="/dinein-page"
            element={clientId ? <MenuManager clientId={clientId} /> : <Navigate to="/login" />}
          />
          <Route
            path="/swiggy-page"
            element={clientId ? <SwiggyMenuManager clientId={clientId} /> : <Navigate to="/login" />}
          />
          <Route
            path="/zomato-page"
            element={clientId ? <ZomatoMenuManager clientId={clientId} /> : <Navigate to="/login" />}
          />
          <Route
            path="/menu-page"
            element={clientId ? <MenuTypeSelector clientId={clientId} onAdd={() => { }} /> : <Navigate to="/login" />}
          />
          ...
          <Route
            path="/orders-view"
            element={clientId ? <OrdersVisiblePage latestOrder={latestOrder} /> : <Navigate to="/login" />}
          />

          {/* Other modules */}
          <Route
            path="/combo-page"
            element={clientId ? <ComboPage /> : <Navigate to="/login" />}
          />
          <Route
            path="/kds-page"
            element={clientId ? <KitchenDisplay /> : <Navigate to="/login" />}
          />
          <Route
            path="/invoice"
            element={clientId ? <InvoicePage /> : <Navigate to="/login" />}
          />
          <Route
            path="/report-page"
            element={clientId ? <ReportsPage /> : <Navigate to="/login" />}
          />
          <Route
            path="/add-users"
            element={clientId ? <ReportsPage /> : <Navigate to="/login" />}
          ...
          <Route
            path="/table-overview"
            element={clientId ? <TableOverview clientId={clientId} tables={tables} /> : <Navigate to="/login" />}
          />
