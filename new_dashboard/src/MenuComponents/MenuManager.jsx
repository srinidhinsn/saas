    ...
    return (
        <div className="menu-manager-container">
            ...
            <div className="tab-buttons">
                {[, "Categories/Items", "addons", "addonGroups", "combo"].map(tab => (
                    <button
                        key={tab}
            ...
            <div className="tab-content">
                ...
                {activeTab === "addons" && <div>Addons Component (coming soon)</div>}
                {activeTab === "addonGroups" && <div>Addon Groups Component</div>}
