...
import { isRentalCategoryId, isRentalRealm } from '../Menu-utils/menuUtils';
...
const UniversalAddModal = ({
  ...
  <div>
    <label className="block text-sm font-medium mb-2 text-text-primary">Rental Duration *</label>
