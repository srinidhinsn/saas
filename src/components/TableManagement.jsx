...
//         alert("Please fix highlighted rows before generating tables.");
//         return;
//       }
...
//           <h1 className="text-4xl md:text-5xl font-serif italic mb-4 text-gray-800">Table Management</h1>
//           {/* <p className="text-gray-600 text-base">Manage your restaurant tables efficiently</p> */}
//         </div>
...
//                   className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 bg-white text-gray-700"
//                 />
//               </div>
//               <select
//                 value={statusFilter}
...
//             <div className="text-sm text-gray-600 font-medium mb-1">Total Tables</div>
...
//             <div className="text-sm text-green-700 font-medium mb-1">Available</div>
//             <div className="text-3xl font-bold text-green-600">{tables.filter(t => t.status === 'Vacant').length}</div>
//           </div>
//           <div className="bg-red-50 rounded-xl shadow-sm p-5 border border-red-200">
//             <div className="text-sm text-red-700 font-medium mb-1">Occupied</div>
//             <div className="text-3xl font-bold text-red-600">{tables.filter(t => t.status === 'Occupied').length}</div>
//           </div>
//           <div className="bg-yellow-50 rounded-xl shadow-sm p-5 border border-yellow-200">
//             <div className="text-sm text-yellow-700 font-medium mb-1">Reserved</div>
//             <div className="text-3xl font-bold text-yellow-600">{tables.filter(t => t.status === 'Reserved').length}</div>
//           </div>
//         </div> */}
...
//             return (
//                 <div key={table.id} className={`${config.card} rounded-lg shadow-sm overflow-hidden border-2 transition-all duration-200 hover:shadow-lg`}>  <div className="p-5 border-b bg-white bg-opacity-50">
//                   <div className="flex justify-between items-start mb-2">
//                     <div className="flex-1">
//                     <div className="text-xl font-bold text-gray-800 mb-1">{table.name}</div>
//                     <div className="text-xs text-gray-600">Seating: <span className="font-bold text-gray-800">{table.table_type}</span></div>
//                     <div className="text-xs text-gray-600">Zone: <span className="font-bold text-gray-800">{table.location_zone}</span></div>
//                     </div>
//                     {config.icon}
//                   </div>
//                   <div className="flex items-center justify-center">
//                   <span className={`px-3 py-1 rounded-full text-xs font-bold ${table.status === 'Vacant' ? 'bg-green-100 text-green-700' :
...
//                 <div className="p-2 bg-white bg-opacity-50 flex gap-2">
//                   <button
//                     className="flex-1 flex items-center justify-center gap-1 bg-blue-500 text-white py-1.5 rounded-lg hover:bg-blue-600 transition-colors font-semibold text-xs shadow-sm"
//                     onClick={() => setEditRowId(table.id)}
//                   >
//                     <FaEdit className="text-xs" /> Edit
//                   </button>
//                   <button
//                     className="flex-1 flex items-center justify-center gap-1 bg-red-500 text-white py-1.5 rounded-lg hover:bg-red-600 transition-colors font-semibold text-xs shadow-sm"
...
//                 <h3 className="text-xl font-bold text-gray-800">Edit Table</h3>
//                 <button className="text-gray-500 hover:text-gray-700 transition-colors p-1" onClick={() => { setEditRowId(null); setEditFieldErrors({}); }}>
//                   <FaTimes size={24} />
//                 </button>
//               </div>
//               {tables.filter(table => table.id === editRowId).map(table => (
//                 <div className="p-6" key={table.id}>
//                   <div className=" bg-gradient-to-r from-orange-50 to-yellow-50 rounded-lg border-2 border-orange-200">
//                     <div className="text-center">
//                       <div className="">
//                         <span className="text-xs font-semibold text-gray-600 uppercase tracking-wide">Table Name</span>
//                         <div className="text-2xl font-bold text-gray-900 mt-1">{table.name}</div>
//                       </div>
...
//                         }}
//                         className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 ${editFieldErrors.table_type ? 'border-red-500 bg-red-50' : 'border-gray-300'
//                           }`}
//                       />
...
//                         className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 ${editFieldErrors.location_zone ? 'border-red-500 bg-red-50' : 'border-gray-300'
//                           }`}
//                       >
//                         <option value="AC">AC</option>
//                         <option value="Non-AC">Non-AC</option>
...
//                         className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 ${editFieldErrors.status ? 'border-red-500 bg-red-50' : 'border-gray-300'
//                           }`}
//                       >
//                         <option value="Vacant">Vacant</option>
//                         <option value="Occupied">Occupied</option>
...
//                     <button
//                       className="flex-1 bg-green-500 text-white py-3 rounded-lg hover:bg-green-600 transition-colors font-bold shadow-md flex items-center justify-center gap-2"
...
//           <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
//             <div className="bg-white rounded-xl w-full max-w-md shadow-2xl border-2 border-yellow-400 animate-pulse-slow">
//               <div className="p-8 text-center">
//                 <div className="text-6xl mb-4 animate-bounce">⚠️</div>
//                 <h3 className="text-2xl font-bold text-gray-800 mb-3">Confirm Deletion</h3>
//                 <p className="text-gray-600 mb-4">
//                   Are you sure you want to delete <strong className="text-red-600 text-xl">{selectedDeleteTables.length}</strong> table(s)?
//                 </p>
//                 <div className="flex flex-wrap gap-2 justify-center mb-6 max-h-32 overflow-y-auto p-2 bg-gray-50 rounded-lg">
//                   {tables.filter(t => selectedDeleteTables.includes(t.id)).map(t => (
//                     <span key={t.id} className="px-3 py-1.5 bg-red-100 text-red-700 rounded-full text-sm font-bold border border-red-300">
//                       {t.name}
//                     </span>
//                   ))}
//                 </div>
...
//                   <button
//                     className="flex-1 bg-yellow-500 text-white py-3 rounded-lg hover:bg-yellow-600 transition-colors font-bold shadow-md"
//                     onClick={() => {
...
//             <div className="bg-white rounded-xl w-full max-w-md shadow-2xl border-4 border-red-500">
//               <div className="p-8 text-center">
//                 <div className="text-7xl mb-4">🗑️</div>
//                 <h3 className="text-3xl font-bold text-red-600 mb-4">Final Confirmation</h3>
//                 <div className="bg-red-50 border-2 border-red-300 rounded-lg p-4 mb-6">
//                   <p className="text-gray-800 font-semibold text-lg">
//                     This action is <span className="text-red-600 font-black text-xl">IRREVERSIBLE</span>
//                   </p>
//                   <p className="text-gray-700 mt-2">
//                     All selected tables will be <strong>permanently deleted</strong>.
//                   </p>
//                 </div>
//                 <div className="flex gap-3">
//                   <button
//                     className="flex-1 bg-red-600 text-white py-4 rounded-lg hover:bg-red-700 transition-colors font-bold shadow-lg text-lg flex items-center justify-center gap-2"
...
//                 </h2>
//                 <button onClick={() => setShowConfirmDelete(false)} className="text-gray-500 hover:text-gray-700 transition-colors p-1">
//                   <FaTimes size={20} />
//                 </button>
//               </div>
//               <div className="p-6">
...
//                     <button className="bg-red-600 text-white rounded-sm px-4" onClick={confirmDelete}>Yes</button>
//                     <button className="bg-gray-600 text-white rounded-sm px-4" onClick={() => setShowConfirmDelete(false)}>No</button>
//                   </div>
//                 </div>
//               </div>
//             </div>
