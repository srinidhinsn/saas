                    ...
                    <div className="px-6 py-4">
                        <div>
                            ...
                            <input
                                ...
                                value={table.name}
                                onChange={(e) =>
                                    handleEditChange(table.id, "name", e.target.value)
                                }
                                className="w-full px-3 py-2 rounded-md border-default border-border-default focus:outline-none"
                                placeholder="Billing Counter"
                            />
                        </div>
                        ...
                        <div className="space-y-4">
                            {/* No of Seating */}
                            <div>
                                <label className="block text-sm font-medium mb-1 text-gray-700">Terminals</label>
                                ...
                                <input
                                    ...
                                    className={`hidden md:block w-full px-3 py-2 rounded-md border-default border-border-default focus:outline-none ${editFieldErrors?.table_type ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                        }`}
                                />
                                ...
                                <div className={`md:hidden flex items-center gap-2 border rounded-md ${editFieldErrors?.table_type ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                    ...
                                    <button
                                        ...
                                        className="px-2 py-2 text-lg font-bold text-gray-700 hover:bg-gray-100 transition-colors"
                                    >
                                        −
                                    </button>
                                    <input
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="Billing Area">Billing Area</option>
                                    <option value="Pickup Area">Pickup Area</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className={`w-full px-3 py-2 rounded-md border-default border-border-default focus:outline-none ${editFieldErrors?.status ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                        }`}
                                >
...
export default UniversalEditModal_V1;