                    ...
                    <div className="flex items-center justify-between mt-2">
                      <h3 className="text-lg font-bold text-text-primary">
                        {order._derivedMode === 'takeaway'
                          ...
                          : tablesMap[order.table_id] || `Table ${order.table_id}`}
                      </h3>
                    ...
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-lg sm:text-xl font-bold text-text-primary truncate">
                          {selectedOrder._derivedMode === 'takeaway'
                            ? selectedOrder.customer_name || 'Takeaway Order'
...
`}</style>
      ...
      <LineItemsModal isOpen={lineItemsModalOpen} onClose={() => setLineItemsModalOpen(false)} mainItem={selectedMainItem}
        lineItems={lineItemsDetails} onAddMainOnly={handleAddMainItemOnly} onAddWithAddons={handleAddMainItemWithLineItems} />

      <SimpleDeleteConfirm isOpen={showDeleteModal} onClose={() => setShowDeleteModal(false)} onConfirm={confirmDeleteOrder}
        title="Delete Order" message="Want to Delete this Order ?" />

      <SimpleDeleteConfirm isOpen={showDeleteModals} onClose={() => setShowDeleteModals(false)}
