...
//   return (
//     <header className="bg-bg-primary shadow-sm sticky top-0 z-50 border-b-default border-border-default transition-colors duration-300">
//       <div className="mx-auto px-4 md:px-6 lg:px-8 py-3 flex items-center justify-between">
...
//         {/* ClientId with Theme Toggle */}
//         <button
//           onClick={toggleTheme}
//           className="flex items-center gap-2 text-2xl lg:text-3xl font-serif italic text-action-primary transition-colors duration-300 group"
//           title={darkMode ? 'Switch to light mode' : 'Switch to dark mode'}
//         >
//           <span>{(clientId || 'APP').toUpperCase()}</span>
//         </button>
...
//             onClick={() => setProfileOpen(prev => !prev)}
//           >
//             <div className={`cursor-pointer px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 ${
//               active === 'profile'
//                 ? 'text-action-primary '
//                 : 'text-text-primary'
//             }`}>
...
//             {/* DROPDOWN MENU */}
//             <div className={`
//               absolute right-0 mt-2 w-40 bg-bg-primary  rounded-lg shadow-lg border border-border-default
//               transition-all duration-200
//               opacity-0 invisible translate-y-2 
//               group-hover:opacity-100 group-hover:visible group-hover:translate-y-0
//               ${profileOpen ? "opacity-100 visible translate-y-0" : ""}
...
//                     className="block w-full text-left px-4 py-2 text-sm text-action-primary hover:bg-bg-tertiary  transition-colors"
//                   >
//                     Profile
//                   </button>
//                 </li>
...
//                   <button
//                     onClick={() => onLogout?.()}
//                     className="block w-full text-left px-4 py-2 text-sm text-text-primary  hover:bg-bg-tertiary transition-colors"
//                   >
//                     Logout
//                   </button>
//                 </li>
