        ...
        <div className="Navbar-container">
            <aside className="sidebar">
                ...
                <ul className="menu">
                    ...
                    <ClickSpark>
                        <li title="Managing Table" onClick={() => go('/table-selection')} className={isActive('/main/table-selection') ? 'page-active' : ''}>
                    ...
                    <ClickSpark>
                        <li title="Take an Order" onClick={() => go('/view-tables')} className={isActive('/main/view-tables') ? 'page-active' : ''}>
