        ...
        <div className="Navbar-container">
            <aside className="sidebar">
                ...
                <ul className="menu">
                    ...
                    <ClickSpark>
                        <li title="Realm" onClick={() => go('/client-details_v3')} className={isActive('/main/client-details_v3') ? 'page-active' : ''}>
                            <FaHamburger /><span>Menu</span>
                            {!isActive('/main/client-details_v3') && <span className="arrow-indicator"><MdKeyboardArrowRight /></span>}
                        </li>
                    </ClickSpark>
                    {/* <ClickSpark>
