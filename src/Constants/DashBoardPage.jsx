            ...
            <div className="grid-layout">
              ...
              <div className="grids dash-cards">
                ...
                <div>
                  ...
                  <div className="title">Preparing Orders</div>
                </div>
              ...
              <div className="grids dash-cards">
                ...
                <div>
                  ...
                  <div className="title">Served Orders</div>
                </div>
...
// import { PiHamburgerThin } from "react-icons/pi";
// import { useTheme } from "../ThemeChangerComponent/ThemeProvider";
// import { MdDeliveryDining, MdOutlineTableBar, MdOutlineSoupKitchen } from "react-icons/md";
// import { BsPersonCheck } from "react-icons/bs";
// import { GoPackageDependents } from "react-icons/go";
// import { TbToolsKitchen3 } from "react-icons/tb";
...
//           });
//         });
//         const topFiveItems = Object.entries(itemCounts)
//           .map(([itemName, orders]) => ({ itemName, orders }))
//           .sort((a, b) => b.orders - a.orders)
//           .slice(0, 5);
//         setTopItemsData(topFiveItems);
...
//         setTotalOrders(filteredOrders.length);
//         setPendingOrders(filteredOrders.filter(o => ["pending", "preparing"].includes(o.status)).length);
//         setTotalEarnings(Math.round(filteredOrders.reduce((sum, o) => sum + (parseFloat(o.total_price) || 0), 0)));
//         setTotalCustomers(filteredOrders.length);
//         setNewOrders(filteredOrders.filter(o => o.status === "new").length);
//         setPreparingOrders(filteredOrders.filter(o => o.status === "preparing").length);
...
//           ordersByGroup[groupKey].count += 1;
//         });
//         const sortedData = Object.values(ordersByGroup).sort((a, b) =>
//           timeFilter === "Daily"
...
//   const getSalesLabel = () => {
//     switch (timeFilter) {
//       case "Daily": return "Sales today";
//       case "Weekly": return "Sales this week";
//       case "Monthly": return "Sales this month";
//       case "Quarterly": return "Sales this quarter";
//       case "Half Yearly": return "Sales last 6 months";
//       case "Yearly": return "Sales this year";
...
//   const getOrdersLabel = () => {
//     switch (timeFilter) {
//       case "Daily": return "Orders today";
//       case "Weekly": return "Orders this week";
//       case "Monthly": return "Orders this month";
//       case "Quarterly": return "Orders this quarter";
//       case "Half Yearly": return "Orders last 6 months";
//       case "Yearly": return "Orders this year";
...
//         <div className="card"><FaHamburger className="icon" /><div><p>{totalOrders}</p><span>Total Orders</span></div></div>
//         <div className="card"><PiHamburgerThin className="icon" /><div><p>{pendingOrders}</p><span>Pending Orders</span></div></div>
//         <div className="card"><RiMoneyRupeeCircleLine className="icon" /><div><p>₹{totalEarnings}</p><span>Total Earnings</span></div></div>
//         <div className="card"><BsPersonCheck className="icon" /><div><p>{totalCustomers}</p><span>Customers</span></div></div>
//         <div className="card"><MdOutlineTableBar className="icon" /><div><p>{newOrders}</p><span>New</span></div></div>
//         <div className="card"><MdOutlineSoupKitchen className="icon" /><div><p>{preparingOrders}</p><span>Preparing</span></div></div>
//         <div className="card"><TbToolsKitchen3 className="icon" /><div><p>{servedOrders}</p><span>Served</span></div></div>
//         <div className="card"><GoPackageDependents className="icon" /><div><p>0</p><span>Take away</span></div></div>
//         <div className="card"><MdDeliveryDining className="icon" /><div><p>0</p><span>Delivery</span></div></div>
//       </div>
...
//           <h3>Sales Value</h3>
//           <p className="chart-sub">₹{totalEarnings} — {getSalesLabel()}</p>
...
//         <div className="chart-box">
//           <h3>Order Sales</h3>
//           <p className="chart-sub">#{totalOrders} order(s) — {getOrdersLabel()}</p>
//           <ResponsiveContainer width="100%" height={200}>
//             <LineChart data={chartData}>
//               <CartesianGrid strokeDasharray="3 3" />
//               <XAxis dataKey="date" />
