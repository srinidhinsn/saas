...
//                 {selectedTable && (
//                     <div className="orderOverlayContainer_v2_2025">
//                         <div className="orderOverlayContentSection_v2_2025">

//                             <div className="categoryListPanel_v2_2025">
//                                 <div className="itemSearchBarWrapper_v2_2025">
//                                     <FiSearch className="searchIconInline_v2_2025" />
//                                     <input
//                                         className="searchInputField_v2_2025"
//                                         type="text"
//                                         placeholder="Search items..."
//                                         value={searchTerm}
//                                         onChange={(e) => setSearchTerm(e.target.value)}
...
//                                     />
//                                 </div>
//                                 <ul className="categoryListItems_v2_2025">
//                                     {categories
//                                         .filter(cat => !cat.parentId)
//                                         .map(cat => (
//                                             <CategoryNode
...
//                             <div className="itemsGridPane_v2_2025">
//                                 <div className="itemsGridLayout_v2_2025" role="list">
//                                     {getFilteredItems().map(item => (
//                                         <div
//                                             key={item.id}
//                                             className="itemGridCard_v2_2025"
//                                             onClick={() => handleItemClick(item)}
//                                             role="listitem"
//                                             tabIndex={0}
//                                             onKeyPress={e => { if (e.key === 'Enter') handleItemClick(item); }}
//                                             aria-label={`${item.name} price ₹${item.unit_price}`}
//                                         >
//                                             <h4 className="itemNameText_v2_2025">{item.name}</h4>
//                                             <div className="itemPriceTag_v2_2025">₹{item.unit_price}</div>
//                                         </div>
//                                     ))}
//                                 </div>
//                             </div>

//                             <div className="orderFormSection_v2_2025">
//                                 <OrderForm
//                                     table={selectedTable}
//                                     mode={selectedTable?.mode || "Dine In"}
//                                     onOrderCreated={async (latestOrder) => {
