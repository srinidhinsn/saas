...
//                                     <p className="font-medium">Table #: <span id="tableNumber">{order.table_id}</span></p>
//                                     <p>Server: <span id="serverName">{order.server_name || "N/A"}</span></p>
//                                     <p>Guests: <span id="guestCount">{order.guest_count || "N/A"}</span></p>
//                                 </div>
//                             </div>
//                             <div>
...
//                             <p>Follow us on social media @bellavistarestaurant</p>
//                         </div>
//                         {/* Footer buttons inside the modal */}
//                         <div className="footer-buttons no-print" style={{ display: "flex", justifyContent: "center", gap: "1rem", marginTop: "1rem" }}>
//                             <button onClick={() => window.print()} className="btn-orange">
//                                 🖨️ Print Invoice
//                             </button>
//                             <button onClick={() => alert("📧 Invoice email feature would integrate with your email system. This is a demo.")} className="btn-blue">
//                                 📧 Email Invoice
//                             </button>
//                             <button onClick={() => alert("➕ New invoice functionality here. In a real system, this would reset invoice data.")} className="btn-green">
//                                 ➕ New Invoice
//                             </button>
//                         </div>
//                     </div>
