...
//       doc.text(`-₹${discountAmount.toFixed(2)}`, pageWidth - 80, y, { align: "right" });
//       y += 18;
...
//           <h1>{clientId.toUpperCase()}</h1>
//           <h2>INVOICE</h2>
//         </div>
//         <div className="billing-header-right">
//           <span className="billing-document-number">{documentNumber || "Draft"}</span>
//           <span className="billing-document-date">{new Date().toLocaleDateString()}</span>
//         </div>
//       </div>

//       <div className="billing-customer-section">
//         <div className="billing-bill-to">
//           <h3 className="billing-section-title">Bill To</h3>
//           <div className="billing-form-group">
//             <label className="billing-form-label">Customer ID</label>
//             <CustomerAutocomplete
//               value={selectedOrder.customer_id || ""}
//               onChange={(newValue) => {
//                 setSelectedOrder((prev) => ({ ...prev, customer_id: newValue }));
...
//           <div className="billing-form-group">
//             <label className="billing-form-label">Email</label>
//             <input
//               type="email"
//               value={selectedOrder.contact_email || ""}
//               onChange={(e) => setSelectedOrder((prev) => ({ ...prev, contact_email: e.target.value }))}
...
//           <div className="billing-form-group">
//             <label className="billing-form-label">Phone</label>
//             <input
//               type="text"
//               value={selectedOrder.contact_phone || ""}
//               onChange={(e) => setSelectedOrder((prev) => ({ ...prev, contact_phone: e.target.value }))}
...
//           <h3 className="billing-section-title">Order Info</h3>
//           <p><strong>Table:</strong> {tablesMap[selectedOrder.table_id]?.name || "N/A"}</p>
//           <p><strong>Type:</strong> {selectedOrder.mode || "Dine-In"}</p>
...
//               <tr key={idx}>
//                 <td>{item.name}</td>
//                 <td className="align-right">{item.quantity ?? 0}</td>
//                 <td className="align-right">₹{(item.unit_price ?? 0).toFixed(2)}</td>
//                 <td className="align-right">₹{((item.unit_price ?? 0) * (item.quantity ?? 0)).toFixed(2)}</td>
//               </tr>
//             ))}
...
//             </tr>
//             <tr className="billing-summary-row">
//               <td colSpan={3} className="align-right">Discount</td>
//               <td className="align-right">-₹{discountAmount.toFixed(2)}</td>
//             </tr>
//             <tr className="billing-summary-row">
//               <td colSpan={3} className="align-right">GST ({taxPercent}%)</td>
//               <td className="align-right">₹{taxAmount.toFixed(2)}</td>
//             </tr>
//             <tr className="billing-summary-row billing-total-row">
...
//           <div className="billing-control-group">
//             <label className="billing-control-label">GST (%)</label>
//             <input
//               type="number"
//               value={taxPercent}
//               min="0"
...
//           <div className="billing-control-group">
//             <label className="billing-control-label">Discount</label>
//             <input
//               type="number"
//               value={discount}
//               min="0"
...
//           <div className="billing-control-group">
//             <label className="billing-control-label">Type</label>
//             <select
//               value={discountIsPercent ? "percent" : "fixed"}
//               onChange={(e) => setDiscountIsPercent(e.target.value === "percent")}
...
//         <div className="billing-payment-status-group">
//           <span className="billing-payment-status-label">Payment Status</span>
//           <div className="billing-status-buttons">
//             {["Pending", "Paid", "Partial", "Due"].map((statusOption) => (
//               <button
//                 key={statusOption}
//                 type="button"
//                 className={`billing-status-btn ${paymentStatus === statusOption ? "active" : ""}`}
//                 onClick={() => setPaymentStatus(statusOption)}
//               >
//                 {statusOption}
//               </button>
...
//             }}
//           />
//           <label htmlFor="split-payment-toggle" className="billing-checkbox-label">
//             Enable Split Payment
//           </label>
//         </div>
...
//           {splitPaymentEnabled ? (
//             <div className="billing-split-payments">
//               {paymentSplits.map((split, idx) => (
//                 <div key={idx} className="billing-split-row">
//                   <select
//                     value={split.method}
//                     onChange={(e) => {
//                       const newSplits = [...paymentSplits];
...
//                 </div>
//               ))}
//               <button type="button" className="billing-btn-add" onClick={addSplitRow}>
//                 + Add Payment Method
//               </button>
//             </div>
//           ) : (
//             <div className="billing-single-payment">
//               <div className="billing-control-group">
//                 <label className="billing-control-label">Payment Method</label>
//                 <select
//                   value={method}
//                   onChange={(e) => {
//                     setMethod(e.target.value);
...
//               </div>
//               <div className="billing-control-group">
//                 <label className="billing-control-label">Total Amount</label>
//                 <input
//                   type="number"
//                   value={total}
//                   readOnly
...
//       <div className="billing-actions-section">
//         <button
//           onClick={saveInvoiceDraft}
//           disabled={saving}
...
//           <div>
//             <h1 className="billing-page-title">Billing & Invoices</h1>
//             <p className="billing-page-subtitle">Manage orders and generate invoices</p>
//           </div>
//         </header> */}

//         <div className="billing-content-wrapper">
//           <aside className="billing-orders-sidebar">
//             <div className="billing-orders-header">
//               <h2>📋 Today's Orders</h2>
//             </div>
            
//             <div className="billing-orders-list">
//               {loading && <p className="billing-loading-text">Loading orders...</p>}
//               {!loading && orders.length === 0 && <p className="billing-empty-text">No served orders today</p>}
//               {orders.map((order) => {
//                 const tableName = tablesMap[order.table_id]?.name || `Table ${order.table_id}`;
//                 const itemsWithPrice = (order.items || []).map((item) => ({
//                   ...item,
...
//                     tabIndex={0}
//                     role="button"
//                     className={`billing-order-card ${isSelected ? "selected" : ""}`}
//                     onClick={() => handleSelectOrder(order)}
//                     onKeyDown={(e) => {
//                       if (e.key === "Enter" || e.key === " ") {
//                         e.preventDefault();
...
//                     aria-pressed={isSelected}
//                   >
//                     <h4 className="billing-order-table-name">{tableName}</h4>
//                     <div className="billing-order-id">Order #{order.id}</div>
//                     <div className="billing-order-total">₹{orderTotal.toFixed(2)}</div>
//                     <time 
//                       dateTime={order.created_at} 
//                       className="billing-order-time"
//                     >
...
//                   <section className="billing-modal-content billing-invoice-section">
//                     <button 
...
//             </>
//           ) : selectedOrder ? (
//             <section ref={invoiceRef} className="billing-invoice-section">
//               {renderInvoiceContent()}
//             </section>
//           ) : (
//             <section className="billing-invoice-placeholder">
//               <p>📋 Select an order to view invoice details</p>
//             </section>
//           )}
//         </div>
