...
def login_user_service(client_id: str,username: str,password: str,db: Session):
    ...
    return {"screen_id": screen_id,"access_token": access_token,"refresh_token": refresh_token,"token_type": "bearer","client_name": client_model.name}
...
DEFAULT_CLIENT_CATEGORIES = [
    ...
    },
    {
        ...
        "sub_categories": ["morning(09:30-11:30)"],
