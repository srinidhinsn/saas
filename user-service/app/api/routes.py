...
@router.get("/test")
async def test_msg(clientId: str, context: str = Depends(verify_token)):
    print("test context - ", context)
    context2: SaasContext = saasContext.get()
    print("test context2 - ", context2)
    print("test context3 - ", saasContext.get())
