...
5. CMD: pip install fastapi uvicorn psycopg2-binary sqlalchemy alembic passlib bcrypt==4.1.2 python-jose setuptools pytest httpx razorpay python-multipart 
