...
const DocumentManager = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            await axios.post(
                `http://localhost:8004/saas/${clientId}/document/upload`,
                formData,
                {
    ...
    const handleReplace = async () => {
        ...
        try {
            await axios.post(
                `http://localhost:8004/saas/${clientId}/document/replace?doc_id=${selectedDocId}`,
                formData,
                {
                    headers: { ...headers, "Content-Type": "multipart/form-data" },
                }
    ...
    const handleDownload = async (docId) => {
        try {
            const res = await axios.get(
                `http://localhost:8004/saas/${clientId}/document/download?doc_id=${docId}`,
                {
                    headers,
                    responseType: "blob",
                }
