...
function ZomatoMenuItemList({ clientId, category }) {
      ...
      <div className="menu-item-table-container">
        ...
        {!isAllCategory && (
          ...
          <button
            className="btn-add"
            onClick={() => {
              const unavailable = items.filter(i => !i.isAvailableZomato);
            ...
            filteredItems.map((item) => (
              ...
              >
                ...
                <div className="menu-card-body">
                  <h4>{item.name}</h4>
                  <p className="menu-card-price">₹{item.zomatoPrice}</p>
              ...
              <form onSubmit={(e) => { e.preventDefault(); handleEditSave(); }} className="add-menu-item-form">
                <div className="form-entry-wrapper">
                  ...
                  <div className="form-row">
                    <input
                      type="number"
                      value={editingItem.zomatoPrice}
                      onChange={(e) => setEditingItem({ ...editingItem, zomatoPrice: e.target.value })}
  ...
  <div className="modal-overlay" onClick={(e) => {
    ...
    <div className="menu-modal-content scrollable-modal">
      <h3>Unavailable Zomato Items</h3>
      <div className="menu-grid-container">
